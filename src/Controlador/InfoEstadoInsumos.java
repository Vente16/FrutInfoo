 ...
 * @author Home
 */
public class InfoEstadoInsumos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            P.add(new Phrase("INFORME DE ESTADO DEL INSUMO", fontitulo));/*Tipo de fuente del Texto*/
 ...
 /*Parrafo del PDF*/
            ...
            P1.add(new Phrase("Este es el informe de los Insumos autorizados por el Administrador", fondescrip));
            ...
            tabla.addCell("Nombre_Insumo");
            tabla.addCell("Cantidad");
            tabla.addCell("Id_Punto_Venta");
            tabla.addCell("Fecha_Solicitud");
            tabla.addCell("solicitud");
