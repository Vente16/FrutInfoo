...
public class FormActualizarLogin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()) {
            ...
            out.println("<label class='control-label col-sm-4' for='Contraseña'>Contraseña:</label>");
            out.println("<div class='col-sm-8'>");
            out.println("<input type='text' class='form-control' id='Contraseña' name='Contraseña' value="+rs.getString("Contraseña")+">");
            out.println("</div>");
            out.println("</div>");
            out.println("<div class='form-group'>");
