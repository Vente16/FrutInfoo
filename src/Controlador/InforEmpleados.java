 ...
 * @author Home
 */
public class InforEmpleados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            P.add(new Phrase("INFORME DE EMPLEADOS", fontitulo));/*Tipo de fuente del Texto*/
            ...
            P1.add(new Phrase("Este es un informe de los empleados de nuestra empresa", fondescrip));
