...
public class FacturaVenta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         response.setContentType("application/pdf");/** Se cambia el contenido de texto por el que nesecitamos que es pdf**/
        ...
        try {
            ...
            P.add(new Phrase("FACTURA DE VENTAS", fontitulo));/*Tipo de fuente del Texto*/
            ...
            P1.add(new Phrase("A continuacion podras observar los datos de la factura del modulo de ventas", fondescrip));
