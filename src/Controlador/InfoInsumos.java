 ...
 * @author Home
 */
public class InfoInsumos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            P.add(new Phrase("INFORME DE INSUMOS", fontitulo));/*Tipo de fuente del Texto*/
            ...
            P1.add(new Phrase("Este es un informe detallado de insumos", fondescrip));
            ...
            tabla.addCell("Nombre Insumo");
            tabla.addCell("Cantidad Insumo");
            tabla.addCell("Valor Insumo");
