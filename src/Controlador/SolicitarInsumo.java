...
public class SolicitarInsumo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Connection con = c.Conectar();
            ...
            PreparedStatement Ps = con.prepareStatement("INSERT INTO solicitud_insumo(nombre_insumo, cantidad, id_punto_venta, fecha_solicitud, solicitud, estado,Habilitado)VALUES(?,?,?,?,'Pendiente',1,1)");
            Ps.setString(1, Ins);
            Ps.setString(2, can);
            Ps.setString(3, sed);
