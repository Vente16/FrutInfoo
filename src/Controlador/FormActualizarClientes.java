...
public class FormActualizarClientes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div class='col-sm-8'>");
            out.println("<input type='date' class='form-control' id='FechaN' name='fechaN' value="+rs.getString("Fecha_nacimiento")+">");
            out.println("</div>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            ...
            out.println("<div class='form-group'>");
            out.println("<label class='col-sm-3 control-label' for='inputSuccess'>");
            out.println("<span class='titulo'>Membrecia</span></label>");
            out.println("<div class='col-xs-8'>");
            out.println("<select class='form-control' id='Membrecia' name='membrecia'>");
            out.println("<option>"+rs.getString("Membrecia")+"</option>");
